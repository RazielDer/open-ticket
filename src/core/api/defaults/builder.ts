...
export interface ODButtonManagerIds_Default {
    ...
    "opendiscord:request-close":{source:"ticket-message"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket},workers:"opendiscord:request-close"},
    "opendiscord:cancel-close-request":{source:"ticket-message"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket},workers:"opendiscord:cancel-close-request"},
    "opendiscord:approve-close-request":{source:"close-request-message"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket},workers:"opendiscord:approve-close-request"},
    "opendiscord:dismiss-close-request":{source:"close-request-message"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket},workers:"opendiscord:dismiss-close-request"},
...
export interface ODEmbedManagerIds_Default {
    ...
    "opendiscord:close-message":{source:"slash"|"text"|"ticket-message"|"reopen-message"|"autoclose"|"close-request"|"awaiting-user-timeout"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket,reason:string|null},workers:"opendiscord:close-message"},
    ...
    "opendiscord:close-request-message":{source:"requested"|"cancelled"|"dismissed"|"approved"|"other",params:{guild:discord.Guild,channel:discord.GuildTextBasedChannel,user:discord.User,ticket:ODTicket,reason:string|null},workers:"opendiscord:close-request-message"},
    "opendiscord:awaiting-user-message":{source:"set"|"reminder"|"cleared"|"other",params:{guild:discord.Guild,channel:discord.GuildTextBasedChannel,user:discord.User,ticket:ODTicket,reason:string|null},workers:"opendiscord:awaiting-user-message"},
}
...
export interface ODMessageManagerIds_Default {
    ...
    "opendiscord:verifybar-close-request-message":{source:"verifybar",params:{guild:discord.Guild|null,channel:discord.TextBasedChannel,user:discord.User,verifybar:ODVerifyBar,originalMessage:discord.Message<boolean>},workers:"opendiscord:verifybar-close-request-message"}
...
export interface ODModalManagerIds_Default {
    ...
    "opendiscord:close-ticket-reason":{source:"ticket-message"|"reopen-message"|"close-request"|"other",params:{guild:discord.Guild,channel:discord.TextBasedChannel,user:discord.User,ticket:ODTicket},workers:"opendiscord:close-ticket-reason"}
